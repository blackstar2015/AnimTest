...
public abstract class CustomCharacterMovementBase : MonoBehaviour
{
    ...
    [field: SerializeField, TabGroup("Size")] public float Height { get; protected set; } = 1.8f;
    [field: SerializeField, TabGroup("Size")] public float Radius { get; protected set; } = 0.3f;

    [field: SerializeField, TabGroup("Grounding")] protected float GroundCheckOffset { get; set; } = 0.1f;         // height inside character where grounding ray starts
    [field: SerializeField, TabGroup("Grounding")] protected float GroundCheckDistance { get; set; } = 0.4f;       // distance down from offset position
    [field: SerializeField, TabGroup("Grounding")] protected float MaxSlopeAngle { get; set; } = 40f;              // maximum climbable slope, character will slip on anything higher
    [field: SerializeField, TabGroup("Grounding")] protected float CoyoteMaxJumpDistance { get; set; } = 0.5f;     // max distance allowed after leaving ground when doing a coyote jump
    [field: SerializeField, TabGroup("Grounding")] protected LayerMask GroundMask { get; set; } = 1 << 0;          // mask for layers considered the ground
    [field: SerializeField, TabGroup("Grounding")] protected float MinGroundedVelocity { get; set; } = 5f;
    ...
    [ShowInInspector, TabGroup("Properties")] public Vector3 Velocity { get => Rigidbody.linearVelocity; protected set => Rigidbody.linearVelocity = value; }
#else
    ...
    [ShowInInspector, TabGroup("Properties")] public Vector3 MoveInput { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public Vector3 LocalMoveInput { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public Vector3 LookDirection { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public bool HasMoveInput { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public bool HasTurnInput { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public bool IsGrounded { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public GameObject SurfaceObject { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public Vector3 SurfaceVelocity { get; protected set; }
    ...
    [ShowInInspector, TabGroup("Properties")] public Vector3 GroundNormal { get; protected set; } = Vector3.up;
    [ShowInInspector, TabGroup("Properties")] public float LastGroundedTime { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public Vector3 LastGroundedPosition { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public float TurnSpeedMultiplier { get; set; } = 1f;
    [ShowInInspector, TabGroup("Properties")] protected Vector3 GroundCheckStart => transform.position + transform.up * GroundCheckOffset;
    [ShowInInspector, TabGroup("Properties")] public Vector3 SplineLookDirection { get; protected set; }
    [ShowInInspector, TabGroup("Properties")] public bool HasPath => NavMeshAgent.hasPath;
    [ShowInInspector, TabGroup("Properties")] public bool HasCompletePath => NavMeshAgent.hasPath && Vector3.Distance(NavMeshAgent.path.corners[NavMeshAgent.path.corners.Length - 1], NavMeshAgent.destination) < StoppingDistance;
    ...
    [field: SerializeField, TabGroup("Avoidance")] protected bool EnableAvoidance { get; set; } = false;
    [field: SerializeField, TabGroup("Avoidance")] protected float NeighborDistance { get; set; } = 3f;
    [field: SerializeField, TabGroup("Avoidance")] protected float CornerNeighborDistance { get; set; } = 1f;
    [field: SerializeField, TabGroup("Avoidance")] protected LayerMask NeighborMask { get; set; }
    [field: SerializeField, TabGroup("Avoidance")] protected int MaxNeighbors { get; set; } = 8;
    [field: SerializeField, TabGroup("Avoidance")] protected bool IsClampedToNavMesh { get; set; } = true;
    [field: SerializeField, TabGroup("Avoidance")] protected float ClampLookAheadTime { get; set; } = 0.25f;
    [field: SerializeField, TabGroup("Avoidance")] protected float ClampSearchRadius { get; set; } = 1f;
